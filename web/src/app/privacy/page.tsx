  ...
  return (
    <LegalPage title="プライバシーポリシー">
      ...
      <section>
        <h2>3. 第三者提供</h2>
        <p>
          法令に基づく場合を除き、ご本人の同意なく第三者に提供することはありません。なお、予約システムの運用にあたり、データの保管および予約確認メールの送信を外部のクラウドサービスに委託しています。委託先に対しては、適切な取り扱いがなされるよう必要な監督を行います。
        </p>
      </section>
